          ...
          <div className="lp-inner">
            ...
            {props.type === "sub" ? (
              <div className="lp-steps sub">
                ...
                <div><Icon className="material-symbols-outlined" style={{color:"#74efeb"}} >play_circle</Icon></div>
                  <hr className="inst-step-hr"></hr>
              ...
              <div className="lp-steps pub">
                <div className="inst-step step1">
                  <div >
                    <Icon className="material-symbols-outlined" style={{color:"#74efeb"}}>menu</Icon>
                  </div>
                  <hr className="inst-step-hr"></hr>
                  {/* <p className="title">Step 1</p> */}
                  <p className="desc">Expand the SideBar and Start a Party</p>
                ...
                <div className="inst-step step2">
                  <div><Icon className="material-symbols-outlined" style={{color:"#74efeb"}}>link</Icon></div>
                  <hr className="inst-step-hr"></hr>
                  {/* <p className="title">Step 2</p> */}
                  <p className="desc">
